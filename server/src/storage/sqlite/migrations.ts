...
//
// Version 1 is the whole current schema: pre-release migrations 1-7 were
// flattened back into the baseline (there were no installs to migrate).
// Post-release changes append new migrations here.
