...
| `SILVIO_MEMBER_UI` / `SILVIO_ADMIN_UI` | sibling `ui/*/dist` | Built UI directories served at `/app/` (inside the brochure shell, #12) and `/admin/`; the group root `/` is the server-rendered brochure |
